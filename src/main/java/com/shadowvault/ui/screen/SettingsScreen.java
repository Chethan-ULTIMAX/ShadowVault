...
public class SettingsScreen implements Screen {
    ...
    public SettingsScreen(Consumer<Screen> navigationCallback, ImageController imageController) {
    ...
    private BorderPane createUI() {
        ...
        title.setStyle("-fx-text-fill: #9b59b6; -fx-font-size: 32px; -fx-font-weight: bold;");
