...
/**
 * Extract Data screen - placeholder for V1.
 * Allows users to select a stego image and extract the hidden data.
 */
public class ExtractDataScreen implements Screen {
    ...
    public ExtractDataScreen(Consumer<Screen> navigationCallback, ImageController imageController) {
