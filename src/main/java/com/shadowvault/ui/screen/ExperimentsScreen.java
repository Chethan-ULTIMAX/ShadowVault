...
public class ExperimentsScreen implements Screen {

    private final BorderPane root;
    private final Consumer<Screen> navigationCallback;
    private final ImageController imageController;

    public ExperimentsScreen(Consumer<Screen> navigationCallback, ImageController imageController) {
    ...
    private BorderPane createUI() {
        ...
        Label title = new Label("Experiments");
        title.setStyle("-fx-text-fill: #2ecc71; -fx-font-size: 32px; -fx-font-weight: bold;");
    ...
    public void onHide() {}
    @Override
    public String getTitle() { return "Experiments"; }
}